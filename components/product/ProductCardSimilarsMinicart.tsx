...
function ProductCardSimilarsMinicart({
  product,
  preload,
  itemListName,
  index,
  ...
  return (
    <div
      {...event}
      class={clx(
        "card card-compact group text-sm w-full xl:max-w-[150px] max-w-[150px] bg-white-15 rounded-lg relative overflow-hidden",
        _class,
      )}
    ...
    >
      ...
      <div class="xl:px-3 px-2 xl:pt-[14px] pt-[10px] xl:pb-4 pb-[11px] flex flex-col flex-grow">
        <a href={relativeUrl} class="block flex-grow focus:outline-none">
          ...
          <h3 class="text-[#363931] font-Hanken-Grotesk xl:text-[16px] text-[14px] line-clamp-2 min-h-[42px] items-center">
            {title}
          </h3>
...
export default ProductCardSimilarsMinicart;
