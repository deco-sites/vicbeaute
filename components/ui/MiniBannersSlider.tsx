  ...
  return (
    <ul
      ...
      class={clx(
        ...
        "lg:grid-cols-5 md:grid-cols-5 pl-0",
        _class?.toString(),
      )}
      {...props}
    />
...
MiniBannersSlider.Dot = Dot;
MiniBannersSlider.Item = Item;
MiniBannersSlider.NextButton = NextButton;
MiniBannersSlider.PrevButton = PrevButton;
MiniBannersSlider.JS = JS;

export default MiniBannersSlider;
