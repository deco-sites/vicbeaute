...
export default function ColorDimensions({
  ...
  cards = [
    {
      title: "Intensidade",
      text: "Refere-se à vivacidade ou saturação de uma cor, indicando quão brilhante ou apagada ela é. Cores intensas são vibrantes e chamativas, enquanto cores menos intensas são mais suaves.",
    },
    {
      title: "Profundidade",
      text: "Relaciona-se à claridade ou escuridão de uma cor, ou seja, se ela é clara, média ou escura. Isso influencia como a cor é percebida em diferentes tonalidades.",
    },
    {
      title: "Temperatura",
      text: "Diz respeito à sensação de calor ou frieza que a cor transmite. Cores quentes (como vermelho, laranja) trazem a sensação de calor, enquanto cores frias (como azul, verde) trazem a sensação de frio.",
    },
  ],
  image = {
