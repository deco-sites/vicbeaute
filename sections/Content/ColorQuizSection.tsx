...
import ColorQuiz, { ResultContent, Step } from "../../islands/ColorQuiz.tsx";
  ...
  steps = [
    {
      ...
      title: "Passo 1",
      description:
        "Responda as perguntas abaixo e saiba quais cores combinam mais com você para realçar a sua beleza natural.",
      formImageDesktop:
    ...
    },
    {
      ...
      description:
        "De acordo com a classificação dos fototipos de pele fornecida pela Sociedade Brasileira de Dermatologia.",
      options: [
        {
          label: "Extremamente branca",
          image:
            "https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/1818/ff6bb37e-0eab-40e1-a454-86856efc278e",
        },
        {
