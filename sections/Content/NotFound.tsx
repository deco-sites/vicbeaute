...
export default function NotFound({
  ...
  description =
    "A beleza que você procura pode ter mudado de lugar. Volte para a página inicial e continue explorando nossos essenciais de maquiagem.",
  ...
  return (
    <div class="w-full flex flex-col md:flex-row relative min-h-[70vh] bg-white-15">
      ...
      <div class="flex-1 flex flex-col justify-center px-8 py-16 md:px-12 lg:px-24 shrink-0 z-10 bg-[#F9F7F5] order-2 md:order-1">
        <h3 class="text-pink-15 font-Inter text-sm uppercase tracking-widest font-semibold mb-4">
          Erro 404
        </h3>
        <h1
